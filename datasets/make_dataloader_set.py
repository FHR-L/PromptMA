...
from .bases import ImageDataset, ImageDatasetSet, ImageDatasetSet_v2
...
def make_dataloader(cfg):
    ...
    train_set = ImageDatasetSet_v2(dataset.train, train_transforms_1, train_transforms_m, train_transforms_2)
