...
from .bases import ImageDataset, ImageDatasetSet
...
def make_dataloader(cfg):
    ...
    train_set = ImageDatasetSet(dataset.train, train_transforms)
    train_set_normal = ImageDatasetSet(dataset.train, val_transforms)
    ...
    val_set = ImageDatasetSet(dataset.query + dataset.gallery, val_transforms)
