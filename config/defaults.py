...
_C.MODEL.LAYER_NUM = 3
_C.MODEL.RATIO = 0.5
_C.MODEL.PROMPT_LAYER_NUM = 3
_C.MODEL.PROMPT_CHUNK = 1
_C.MODEL.PROMPT_LENGTH = 1
_C.MODEL.CENTER_LOSS_WEIGHT = 0.0
_C.MODEL.KL_LOSS_WEIGHT = 0.0
_C.MODEL.PROMPT_ALIGN_LOSS_WEIGHT_2 = 0.0
_C.MODEL.CENTER_MARGIN = 0.3
_C.MODEL.SPECIAL_LEARNER = True
_C.MODEL.FUSION_LAYER = True
_C.MODEL.TOKEN_SELECT_TYPE = 'all'
_C.MODEL.PROMPT_CHANGE_MACHINE = 'transpose'
_C.MODEL.FUSION_CLASS_TOKEN = 'un-diagonal'
_C.MODEL.TOKEN_SELECT_ALPHA = 0.5
...
# AL or BL
_C.MODEL.AL = False
_C.MODEL.SHARED_CLASS_TOKEN = False
_C.MODEL.MODAL_ALIGN = False
_C.MODEL.ALPHA = 4

# Fusion Model
_C.MODEL.FUSION_MODEL = CN()
_C.MODEL.FUSION_MODEL.USE = False
_C.MODEL.FUSION_MODEL.VERSION = 'v1'
_C.MODEL.FUSION_MODEL.LAYER_NUM = 2
